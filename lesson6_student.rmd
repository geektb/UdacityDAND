...
setwd("~/Google Drive/School/C751 - Data Analysis with R/lesson6/")
getwd()
...
qplot(x = carat, y = price, data = diamonds,
      xlim=c(0, quantile(diamonds$carat, 0.95)),
      ylim=c(0, quantile(diamonds$price, 0.95))) +
  geom_point(fill = I('#F79420'), color = I('#000000'), shape = 21)
```
...
ggplot(aes(carat, price), data = diamonds) + 
  geom_point(size = 0.75, alpha = 0.5, position = 'jitter') + 
